...
import { MerchantAssets } from "@/components/merchant/merchant-assets"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"
import { Button } from "@/components/ui/button"
import { merchantService, type GeneratedQR } from "@/lib/merchant"
import { QrCode, History, TrendingUp, Users, Building2 } from "lucide-react"
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="space-y-8">
          ...
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Business Assets</CardTitle>
                <Building2 className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">12</div>
                <p className="text-xs text-muted-foreground">Logos & documents</p>
              </CardContent>
            </Card>
          </div>

          {/* IPFS Merchant Assets section */}
          <MerchantAssets />
